...
type ClusterOrderStatus struct {
	state                 protoimpl.MessageState    `protogen:"opaque.v1"`
	xxx_hidden_State      ClusterOrderState         `protobuf:"varint,1,opt,name=state,proto3,enum=private.v1.ClusterOrderState"`
...
type ClusterOrderCondition struct {
	state                         protoimpl.MessageState    `protogen:"opaque.v1"`
	xxx_hidden_Type               ClusterOrderConditionType `protobuf:"varint,1,opt,name=type,proto3,enum=private.v1.ClusterOrderConditionType"`
